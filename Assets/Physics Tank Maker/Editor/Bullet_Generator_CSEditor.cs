...
namespace ChobiAssets.PTM
{
    ...
    {
        SerializedProperty AP_Projectile_PrefabProp;
        ...
        string[] typeNames = { "AP", "HE", "AP_Projectile" };
        bool folding;


        void OnEnable()
        {
            AP_Projectile_PrefabProp = serializedObject.FindProperty("AP_Projectile_Prefab");
        ...
        public override void OnInspectorGUI()
        {
            ...
            AP_Projectile_PrefabProp.objectReferenceValue = EditorGUILayout.ObjectField("AP Projectile Prefab", AP_Projectile_PrefabProp.objectReferenceValue, typeof(GameObject), true);
            EditorGUILayout.Space();
